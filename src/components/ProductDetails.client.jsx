...
import ProductProxy from '../lib/ProductProxy';
...
function ProductDetailsBlock({children}) {
  ...
  return (
    <div>
      <div className="hidden md:block">
        <ProductTitle as="h1" className="text-5xl font-bold text-black mb-4" />
        {product.vendor && (
...
export default function ProductDetails({product: originalProduct, children}) {
  const product = new ProductProxy(originalProduct);
